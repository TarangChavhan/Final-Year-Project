...
public class Urls {
    public static String webServiceAddress = "http://192.168.68.13:80/mobileapppAPI/";
    ...
    public static String getAllCategoryImages ="http://192.168.68.13:80/mobileapppAPI/images/";
