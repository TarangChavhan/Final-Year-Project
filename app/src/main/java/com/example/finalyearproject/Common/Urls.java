...
public class Urls {
    public static String webServiceAddress = "http://192.168.202.13/mobileapppAPI/";
    ...
    public static String getAllCategoryImages ="http://192.168.202.13/mobileapppAPI/images/";
